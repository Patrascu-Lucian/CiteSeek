...
export function SiteFooter() {
  // The holding page answers every route while this is on, so each link would
  // lead back to it.
  const links = !maintenanceOn();
  ...
  return (
    <footer className="border-border/60 mt-auto border-t">
      <div className={pageShell("5xl", "text-muted-foreground py-8 text-sm")}>
        ...
        <div
          className={links ? "border-border/60 mt-6 border-t pt-6" : undefined}
        >
