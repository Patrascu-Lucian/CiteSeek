...
is the other half — 139 entries of _issue found → fix → lesson_, written when review caught a bug, a
...
| ----------- | ----- | ------------------------------------------------------------------------------------------------------------- |
| Unit        | 1079  | Chunking, extraction, embeddings, prompts, citation markers, usage policy, restored transcripts, local mode   |
