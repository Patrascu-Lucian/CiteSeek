...
is the other half — 25 entries of _issue found → fix → lesson_, written when review caught a bug, a
...
| Integration | 149   | Real Postgres: ingestion, retrieval, chat, usage limits, conversation ownership, cascades       |
